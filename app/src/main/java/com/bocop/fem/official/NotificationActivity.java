...
public class NotificationActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        if ((null != checkedDevice) && (null != checkedDevice.getName())) {
    ...
    public void sendNotification(View view) {
        ...
        mNotifyClient.notify(checkedDevice, notification).addOnSuccessListener(successVoid -> printOperationResult("send notification success.")).addOnFailureListener(e -> printOperationResult("send notification fail, exception."));
    }
    ...
    private Action getNotificationAction() {
        return new Action() {
            ...
            public void onResult(Notification notification, int feedback) {
                String result = ("getNotificationAction feedback: " + feedback + ",notification title: " + notification.getTitle());
    ...
    private void setButtonContentAndTemplate(Notification.Builder builder) {
        HashMap<Integer, String> buttonContents = new HashMap<>(6);
        ...
        switch (templateId) {
            case NOTIFY_TEMPLATE_NO_BUTTON:
                Timber.d("setButtonContentAndTemplate " + 50);
